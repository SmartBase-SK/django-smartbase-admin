...
/***/ "./static/sb_admin/src/js/table_modules/base_module.js":
/*!*************************************************************!*\
  !*** ./static/sb_admin/src/js/table_modules/base_module.js ***!
  \*************************************************************/
...
/* harmony export */   "SBAdminTableModule": () => (/* binding */ SBAdminTableModule)
/* harmony export */ });
class SBAdminTableModule {
  constructor(table) {
    this.table = table;
  }
...
/***/ "./static/sb_admin/src/js/table_modules/column_display_module.js":
/*!***********************************************************************!*\
  !*** ./static/sb_admin/src/js/table_modules/column_display_module.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ColumnDisplayModule": () => (/* binding */ ColumnDisplayModule)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./static/sb_admin/src/js/utils.js");
/* harmony import */ var lodash_debounce__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/debounce */ "./node_modules/lodash/debounce.js");
/* harmony import */ var lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_debounce__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var sortablejs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! sortablejs */ "./node_modules/sortablejs/modular/sortable.esm.js");
/* harmony import */ var _base_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./base_module */ "./static/sb_admin/src/js/table_modules/base_module.js");




class ColumnDisplayModule extends _base_module__WEBPACK_IMPORTED_MODULE_3__.SBAdminTableModule {
  constructor(table) {
    super(table);
    this.defaultVisible = true;
    this.defaultCollapsed = false;
  }
  handleColumnVisibility(col, visible, collapsed) {
    let initialisation = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    if (visible) {
      col.show();
    } else {
      col.hide();
  ...
  createCheckbox(checkboxId, checked) {
    let checkboxClasses = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ['checkbox'];
  ...
  refreshColumnWidget() {
    ...
    cols.forEach(colProxy => {
      ...
      const [checkboxVisible, inputVisible] = this.createCheckbox(checkboxId + '_visible', this.columnsData[this.table.constants.COLUMNS_DATA_COLUMNS_NAME][col.field][this.table.constants.COLUMNS_DATA_VISIBLE_NAME], ['checkbox', 'js-select-all-item']);
      const [checkboxCollapsed, inputCollapsed, labelCollapsed] = this.createCheckbox(checkboxId + '_collapsed', this.columnsData[this.table.constants.COLUMNS_DATA_COLUMNS_NAME][col.field][this.table.constants.COLUMNS_DATA_COLLAPSED_NAME], ['checkbox', 'checkbox-icon']);
      checkboxCollapsed.classList.add('ml-auto');
      labelCollapsed.appendChild((0,_utils__WEBPACK_IMPORTED_MODULE_0__.createIcon)('Pin', ['w-16', 'h-16']));
      labelCollapsed.appendChild((0,_utils__WEBPACK_IMPORTED_MODULE_0__.createIcon)('Pin Filled', ['w-16', 'h-16']));
      inputVisible.addEventListener("change", lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(() => {
        this.handleColumnVisibility(col, inputVisible.checked, inputCollapsed.checked);
      }, 200));
      inputCollapsed.addEventListener("change", lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(() => {
        this.handleColumnVisibility(col, inputVisible.checked, inputCollapsed.checked);
      }, 200));
    ...
    this.sortable = new sortablejs__WEBPACK_IMPORTED_MODULE_2__["default"](widget, {
...
/***/ "./static/sb_admin/src/js/table_modules/detail_view_module.js":
/*!********************************************************************!*\
  !*** ./static/sb_admin/src/js/table_modules/detail_view_module.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DetailViewModule": () => (/* binding */ DetailViewModule)
/* harmony export */ });
/* harmony import */ var _base_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base_module */ "./static/sb_admin/src/js/table_modules/base_module.js");

class DetailViewModule extends _base_module__WEBPACK_IMPORTED_MODULE_0__.SBAdminTableModule {
  afterInit() {
    this.table.tabulator.on("rowClick", (e, row) => {
      if (e.target.closest(".row-select-wrapper")) {
        return;
      }
      window.location = this.table.tableDetailUrl.replace(this.table.constants.OBJECT_ID_PLACEHOLDER, row.getData()[this.table.tableIdColumnName]);
    });
  }
}
...
/***/ "./static/sb_admin/src/js/table_modules/filter_module.js":
/*!***************************************************************!*\
  !*** ./static/sb_admin/src/js/table_modules/filter_module.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _base_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base_module */ "./static/sb_admin/src/js/table_modules/base_module.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils */ "./static/sb_admin/src/js/utils.js");


class FilterModule extends _base_module__WEBPACK_IMPORTED_MODULE_0__.SBAdminTableModule {
  afterInit() {
    (0,_utils__WEBPACK_IMPORTED_MODULE_1__.filterInputValueChangeListener)(`[form=${this.table.filterFormId}]`, event => {
      this.table.refreshTableDataIfNotUrlLoad();
  ...
  filterInputValueChanged(field) {
    const valueElem = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.filterInputValueChangedUtil)(field);
  ...
  focusOnFilterInput(filterElem) {
    setTimeout(() => {
      var _filterElem$querySele;
      filterElem.children[0].click();
      (_filterElem$querySele = filterElem.querySelector('input:not([type="hidden"])')) === null || _filterElem$querySele === void 0 ? void 0 : _filterElem$querySele.focus();
    }, 100);
  }
  showFilter(field) {
...
/***/ "./static/sb_admin/src/js/table_modules/selection_module.js":
/*!******************************************************************!*\
  !*** ./static/sb_admin/src/js/table_modules/selection_module.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SelectionModule": () => (/* binding */ SelectionModule)
/* harmony export */ });
/* harmony import */ var _base_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base_module */ "./static/sb_admin/src/js/table_modules/base_module.js");

class SelectionModule extends _base_module__WEBPACK_IMPORTED_MODULE_0__.SBAdminTableModule {
  constructor(table) {
    super(table);
...
/***/ "./static/sb_admin/src/js/table_modules/table_params_module.js":
/*!*********************************************************************!*\
  !*** ./static/sb_admin/src/js/table_modules/table_params_module.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TableParamsModule": () => (/* binding */ TableParamsModule)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./static/sb_admin/src/js/utils.js");
/* harmony import */ var _base_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./base_module */ "./static/sb_admin/src/js/table_modules/base_module.js");


class TableParamsModule extends _base_module__WEBPACK_IMPORTED_MODULE_1__.SBAdminTableModule {
  loadFromUrl() {
    const params = this.table.getParamsFromUrl();
  ...
  getSortDataFromSorters(sorters) {
    ...
    sorters.forEach(param => {
      sortParams.push({
        column: param['field'] || param['column']['field'],
        dir: param['dir']
      });
    });
    return sortParams;
  ...
  getUrlParams() {
    ...
    if (newSort.toString() !== oldSort.toString()) {
  ...
  createPaginationButtonsFromRange(range, mapFunction, paginationWrapper, currentPage) {
    Array.from({
      length: range
    }, mapFunction).forEach(pageNum => {
      paginationWrapper.appendChild(this.createPaginationButton(pageNum, () => {
  ...
  createPagination(paginationWidget) {
    ...
    if (dataCount > 0) {
      ...
      // TODO: translations
      paginationText.innerHTML = `<strong>${from} - ${to}</strong> of <strong>${this.table.tabulator.modules.page.remoteRowCountEstimate}</strong><span class="max-xs:hidden"> items</span>`;
    } else {
      paginationText.innerHTML = `<strong>0</strong> items`;
    }
    ...
    const prevButton = this.createPaginationButton((0,_utils__WEBPACK_IMPORTED_MODULE_0__.createIcon)('Left', ['w-20', 'h-20']), () => {
    ...
    if (maxPage > activeRange + 1) {
      ...
      if (currentPage > activeRange) {
        // create '1 ... X'
        paginationWrapper.appendChild(this.createPaginationButton(1, () => {
          this.table.tabulator.setPage(1);
        }));
        paginationWrapper.appendChild(this.createPaginationButton((0,_utils__WEBPACK_IMPORTED_MODULE_0__.createIcon)('More', ['w-20', 'h-20', 'mt-8'])));
        if (currentPage > maxPage - activeRange) {
          // create '1 ... X'
          this.createPaginationButtonsFromRange(activeRange, (x, i) => i + 1 + maxPage - activeRange, paginationWrapper, currentPage);
        } else {
          // create '1 ... active range buttons ... X'
          this.createPaginationButtonsFromRange(activeRange, (x, i) => i + currentPage - Math.floor(activeRange / 2), paginationWrapper, currentPage);
          paginationWrapper.appendChild(this.createPaginationButton((0,_utils__WEBPACK_IMPORTED_MODULE_0__.createIcon)('More', ['w-20', 'h-20', 'mt-8'])));
          paginationWrapper.appendChild(this.createPaginationButton(maxPage, () => {
            this.table.tabulator.setPage(maxPage);
          }));
        }
      } else {
        // create 'active range buttons ... X'
        this.createPaginationButtonsFromRange(activeRange, (x, i) => i + 1, paginationWrapper, currentPage);
        paginationWrapper.appendChild(this.createPaginationButton((0,_utils__WEBPACK_IMPORTED_MODULE_0__.createIcon)('More', ['w-20', 'h-20', 'mt-8'])));
        paginationWrapper.appendChild(this.createPaginationButton(maxPage, () => {
          this.table.tabulator.setPage(maxPage);
        }));
      ...
      this.createPaginationButtonsFromRange(maxPage, (x, i) => i + 1, paginationWrapper, currentPage);
    }
    const nextButton = this.createPaginationButton((0,_utils__WEBPACK_IMPORTED_MODULE_0__.createIcon)('Right', ['w-20', 'h-20']), () => {
      this.table.tabulator.setPage(currentPage + 1);
    });
  ...
  createPageSizeDropdownButton(currentPageSize) {
    ...
    pageSizeButton.appendChild((0,_utils__WEBPACK_IMPORTED_MODULE_0__.createIcon)('Down', ['w-20', 'h-20', 'ml-8']));
...
/***/ "./static/sb_admin/src/js/table_modules/views_module.js":
/*!**************************************************************!*\
  !*** ./static/sb_admin/src/js/table_modules/views_module.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class ViewsModule extends _base_module__WEBPACK_IMPORTED_MODULE_0__.SBAdminTableModule {
  refreshViewButtons() {
...
/***/ "./static/sb_admin/src/js/utils.js":
/*!*****************************************!*\
  !*** ./static/sb_admin/src/js/utils.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "filterInputValueChangeListener": () => (/* binding */ filterInputValueChangeListener),
/* harmony export */   "filterInputValueChangedUtil": () => (/* binding */ filterInputValueChangedUtil),
/* harmony export */   "getCookie": () => (/* binding */ getCookie),
/* harmony export */   "getLastDays": () => (/* binding */ getLastDays),
/* harmony export */   "getLastMonths": () => (/* binding */ getLastMonths),
/* harmony export */   "getObjectOrValue": () => (/* binding */ getObjectOrValue),
/* harmony export */   "setCookie": () => (/* binding */ setCookie)
/* harmony export */ });
const createIcon = function (iconId) {
  let classes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ['w-24', 'h-24'];
...
const getLastDays = daysNum => {
  const d = new Date();
  d.setDate(d.getDate() - (daysNum - 1));
  return d;
};
const getLastMonths = monthsNum => {
  const d = new Date();
  d.setMonth(d.getMonth() - monthsNum);
  return d;
};
const getObjectOrValue = value => {
  try {
...
const filterInputValueChangeListener = (inputSelector, callbackFunction) => {
  document.querySelectorAll(inputSelector).forEach(input => {
    input.addEventListener('change', callbackFunction);
    input.addEventListener('SBAutocompleteChange', callbackFunction);
  });
};
const filterInputValueChangedUtil = field => {
  const valueElem = document.querySelector(`#${field.id}-value`);
  const valueOrObject = getObjectOrValue(field.value);
  if ((field.value === "" || field.value === "[]") && field.dataset.emptyLabel) {
  ...
  if (typeof valueOrObject === 'object') {
    ...
    for (let [index, item] of entries.entries()) {
      ...
      if (index === window.sb_admin_const.MULTISELECT_FILTER_MAX_CHOICES_SHOWN - 2 && entries[index + 2]) {
        ...
        // TODO: translate
        labelArray.push(`${entries.length - window.sb_admin_const.MULTISELECT_FILTER_MAX_CHOICES_SHOWN + 1} more`);
        break;
      }
      labelArray.push(item.label);
    }
    valueElem.innerHTML = labelArray.join(', ');
  } else {
    try {
...
"use strict";
/*!*****************************************!*\
  !*** ./static/sb_admin/src/js/table.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tabulator_tables__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tabulator-tables */ "./node_modules/tabulator-tables/dist/js/tabulator_esm.js");
/* harmony import */ var _table_modules_views_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./table_modules/views_module */ "./static/sb_admin/src/js/table_modules/views_module.js");
/* harmony import */ var _table_modules_selection_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./table_modules/selection_module */ "./static/sb_admin/src/js/table_modules/selection_module.js");
/* harmony import */ var _table_modules_column_display_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./table_modules/column_display_module */ "./static/sb_admin/src/js/table_modules/column_display_module.js");
/* harmony import */ var _table_modules_table_params_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./table_modules/table_params_module */ "./static/sb_admin/src/js/table_modules/table_params_module.js");
/* harmony import */ var _table_modules_detail_view_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./table_modules/detail_view_module */ "./static/sb_admin/src/js/table_modules/detail_view_module.js");
/* harmony import */ var _table_modules_filter_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./table_modules/filter_module */ "./static/sb_admin/src/js/table_modules/filter_module.js");
...
class SBAdminTable {
  ...
  afterInit() {
    ...
    (_document$getElementB = document.getElementById('table-selected-rows-bar-select-all')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.addEventListener('change', () => {
  ...
  initModules(modules) {
    ...
    const self = this;
    for (const [key, moduleClass] of Object.entries(modules)) {
      modulesInitialised[key] = new moduleClass(self);
    }
  ...
  buildTabulatorTable() {
    this.defaultRowSelectionFormatter = tabulator_tables__WEBPACK_IMPORTED_MODULE_6__.TabulatorFull.moduleBindings.format.formatters.rowSelection;
    const self = this;
    class ResponsiveLayoutOnDemandPatch extends tabulator_tables__WEBPACK_IMPORTED_MODULE_6__.TabulatorFull.moduleBindings.responsiveLayout {
      update() {}
    }
    tabulator_tables__WEBPACK_IMPORTED_MODULE_6__.TabulatorFull.moduleBindings.responsiveLayout = ResponsiveLayoutOnDemandPatch;
    tabulator_tables__WEBPACK_IMPORTED_MODULE_6__.TabulatorFull.extendModule("format", "formatters", {
    ...
    this.tabulator = new tabulator_tables__WEBPACK_IMPORTED_MODULE_6__.TabulatorFull(this.tableElSelector, {
    ...
    document.addEventListener("SBAdminGlobalDataChanged", function () {
...
window.SBAdminTableModulesClass = {
  'viewsModule': _table_modules_views_module__WEBPACK_IMPORTED_MODULE_0__.ViewsModule,
  'selectionModule': _table_modules_selection_module__WEBPACK_IMPORTED_MODULE_1__.SelectionModule,
  'columnDisplayModule': _table_modules_column_display_module__WEBPACK_IMPORTED_MODULE_2__.ColumnDisplayModule,
  'filterModule': _table_modules_filter_module__WEBPACK_IMPORTED_MODULE_5__.FilterModule,
  'tableParamsModule': _table_modules_table_params_module__WEBPACK_IMPORTED_MODULE_3__.TableParamsModule,
  'detailViewModule': _table_modules_detail_view_module__WEBPACK_IMPORTED_MODULE_4__.DetailViewModule
};
})();

/******/ })()
;
//# sourceMappingURL=table.665d159b6337dd3bca03.js.map