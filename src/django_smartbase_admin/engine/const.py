...
AUTOCOMPLETE_MCP_PAGE_SIZE = 100
AUTOCOMPLETE_MCP_PAGE_SIZE_MAX = 1000
...
TABLE_CELL_EDITED_EVENT_NAME = "SBAdminTableCellEdited"
...
AUTOCOMPLETE_PAGE_SIZE_NAME = "__pageSize__"
